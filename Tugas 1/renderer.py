...
# --- MODIFIKASI DIMULAI ---
from utils import overlay_png, draw_fancy_text, get_filter_mode_name
# --- MODIFIKASI SELESAI ---
...
def draw_avatar_and_ui(final_output, state, assets, current_head_img, current_body_img,
    ...
    # --- MODIFIKASI DIMULAI ---
    # UI Filter (Tugas 1)
    filter_name = get_filter_mode_name(state.get("filter_mode", 0))
    filter_txt = f"Filter: {filter_name} (Keys 0-4)"
    final_output = draw_fancy_text(final_output, filter_txt, cfg.UI_FILTER_POS, 
                                   cfg.UI_FONT, cfg.UI_FILTER_SCALE, cfg.UI_TEXT_COLOR, 
                                   cfg.UI_FILTER_THICKNESS, cfg.UI_BG_COLOR, 
                                   cfg.UI_BG_ALPHA, cfg.UI_PADDING)
    # --- MODIFIKASI SELESAI ---
