...
# --- KONSTANTA FILTER IMAGE (TUGAS 1) ---
# Filter modes: 0=Normal, 1=Average 5x5, 2=Average 9x9, 3=Gaussian, 4=Sharpening
FILTER_MODE_NORMAL = 0
FILTER_MODE_AVG_5 = 1
FILTER_MODE_AVG_9 = 2
FILTER_MODE_GAUSSIAN = 3
FILTER_MODE_SHARPEN = 4

# Keyboard keys untuk filter
FILTER_KEY_NORMAL = ord('0')
FILTER_KEY_AVG_5 = ord('1')
FILTER_KEY_AVG_9 = ord('2')
FILTER_KEY_GAUSSIAN = ord('3')
FILTER_KEY_SHARPEN = ord('4')
...
# --- KONSTANTA COLOR DETECTION (TUGAS 2) ---
# Color detection modes
COLOR_DETECT_GREEN = 'green'
COLOR_DETECT_BLUE = 'blue'
COLOR_DETECT_RED = 'red'
COLOR_DETECT_YELLOW = 'yellow'

# Keyboard keys untuk color detection
COLOR_KEY_GREEN = ord('g')
COLOR_KEY_BLUE = ord('h')  # 'h' untuk hijau (biru dalam bahasa Indonesia)
COLOR_KEY_RED = ord('r')
COLOR_KEY_YELLOW = ord('y')
COLOR_KEY_TOGGLE = ord('c')  # Toggle color detection on/off
...
# Red (Merah) - memiliki 2 rentang karena di ujung spektrum
...
# Detection threshold
COLOR_DETECT_MIN_AREA = 1000  # Minimum area untuk deteksi objek

# Action types yang dipicu saat warna terdeteksi
COLOR_ACTION_TYPES = ['background_change', 'gesture_trigger', 'text_display']
...
AUDIO_SPEAK_THRESHOLD_RMS = 1000
AUDIO_RMS_LEVEL_SMALL = 1500
AUDIO_RMS_LEVEL_MEDIUM = 1800
AUDIO_RMS_LEVEL_WIDE = 2000
AUDIO_RMS_LEVEL_O = 2500
...
# Filter UI position (Tugas 1)
UI_FILTER_POS = (10, 130)
UI_FILTER_SCALE = 0.5
UI_FILTER_THICKNESS = 1

# Color Detection UI position (Tugas 2)
UI_COLOR_DETECT_POS = (10, 160)
UI_COLOR_DETECT_SCALE = 0.5
UI_COLOR_DETECT_THICKNESS = 1
